...
execute join(['function! vital#_bookmarks#Text#CSV#import() abort', printf("return map({'dump': '', 'parse': '', 'parse_record': '', 'dump_file': '', 'dump_record': '', 'parse_file': ''}, \"vital#_bookmarks#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
